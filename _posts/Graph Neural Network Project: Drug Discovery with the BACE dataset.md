...
One GNN model involves using a graph convolutional layer to share information between the nodes in the graph and then make a prediction based on information encapsulates by all the nodes. 
